...
<script type="text/javascript" src="modules/Banners/javascript/fadeslideshow.js">
/***********************************************
...
var mygallery=new fadeSlideShow({
    ...
    {{foreach from=$banner item=bannerinfo name=checked}}
        ["{{$bannerinfo.imageurl}}", "{{$bannerinfo.clickurl}}", "", ""
        {{if $smarty.foreach.checked.last}}
            ]
        {{else}}
            ],
        {{/if}}
    {{/foreach}}{{* no trailing comma after very last image element! *}}
	],
