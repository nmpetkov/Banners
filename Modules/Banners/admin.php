...
class Banners_admin extends AbstractController {
    ...
    public function view($args) {
        ...
        // Check if Banners variable is active, if not then print a message
        $render->assign('bannersenabled', pnModGetVar('Banners', 'banners'));
...
//print_r($banner);exit;
    ...
    public function deleteclient($args) {
        ...
        if (empty($confirmation)) {
            ...
            // assign the full item
            $render->assign('banners', pnModAPIFunc('Banners', 'user', 'getall', array('cid' => $cid)));
    ...
    public function deletefinished($args) {
        ...
        if (empty($confirmation)) {
            ...
            // assign the full item
            $render->assign(pnModAPIFunc('Banners', 'user', 'getfinished', array('bid' => $bid)));
    ...
    public function modifyconfig() {
        ...
        $render->assign(pnModGetVar('Banners'));
